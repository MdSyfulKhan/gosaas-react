...
const PricingStyle1 = ({ data, styleVarient }) => {
  ...
  const getPrice = (monthly) => {
    return pricingType === "monthly" ? monthly : monthly * 10;
  };

  return (
    <section className="position-relative">
      <div
        className={`cs_bg_shape_1 ${
          styleVarient ? styleVarient : "cs_accent_bg"
        }  cs_radius_15 position-absolute`}
      />
